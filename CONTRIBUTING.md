Contributing to MDL Community Token Core
============================

The MDL Community Token Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MDL Community Token Core project, and is not to be
confused with overall mdl Network Protocol consensus changes.

Whether a pull request is merged into MDL Community Token Core rests with the project merge
...
The project leader is the release manager for each MDL Community Token Core release.
