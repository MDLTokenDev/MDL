...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOTDEPOSITIFMN = 4, // ONLY_NONDENOMINATED and not deposit mdl at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZMDL_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
...
public:
    ...
    void ZmdlBackupWallet();
    bool GetZerocoinKey(const CBigNum& bnSerial, CKey& key);
    bool CreateZMDLOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    bool GetMint(const uint256& hashSerial, CZerocoinMint& mint);
    bool GetMintFromStakeHash(const uint256& hashStake, CZerocoinMint& mint);
    bool DatabaseMint(CDeterministicMint& dMint);
    bool SetMintUnspent(const CBigNum& bnSerial);
    bool UpdateMint(const CBigNum& bnValue, const int& nHeight, const uint256& txid, const libzerocoin::CoinDenomination& denom);
    string GetUniqueWalletBackupName(bool fzmdlAuto) const;
    ...
    */
    ...
    CzMDLWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzMDLTracker> zmdlTracker;
    ...
    void setZWallet(CzMDLWallet* zwallet)
    {
        zwalletMain = zwallet;
        zmdlTracker = std::unique_ptr<CzMDLTracker>(new CzMDLTracker(strWalletFile));
    }

    CzMDLWallet* getZWallet() { return zwalletMain; }
    ...
    void setZmdlAutoBackups(bool fEnabled)
    {
    ...
    /** zMDL reset */
    boost::signals2::signal<void()> NotifyzMDLReset;
