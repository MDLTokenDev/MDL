...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000000d30f020125815b8b20e7685ed6d0ed21084786ef0f73d0b384206add36"))
	(1, uint256("0x000008695f53606ad4e536dfe6b83a3dd2fee2c6a16ebe667ac45d5ef9758e12"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1593548552, // * UNIX timestamp of last checkpoint block
    1596507,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // mdl: 1 minute
        ...
        vTreasuryRewardAddress="MC54GbHG1C6EpnmMjZhzDwwQxfNE46DRPi";
        ...
        const char* pszTimestamp = "Jim Rogers, Mark Cuban, Peter Schiff Will Go All-In on Bitcoin, Says Max Keiser - 27/07/2020";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1593528106;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3254343;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000d30f020125815b8b20e7685ed6d0ed21084786ef0f73d0b384206add36"));
        assert(genesis.hashMerkleRoot == uint256("0x78edbd6f6efc01716f3b90848e6081907b60264dcf6db9d314902c8fda80ebd6"));
        ...
        strSporkKey = "040155710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9";
        ...
        strObfuscationPoolDummyAddress = "M8AbHeKXLLJZn7DnZeCtpLahtenWUBscFU";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zmdl to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 60; // mdl: 10 minutes
        nTargetSpacing = 1 * 60; // mdl: 1 minute
        nLastPOWBlock = 1001;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 110); // Testnet mdl addresses start with 'm'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mdl script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mdl BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mdl BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mdl BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 10 * 60; // mdl: 10 minutes
        nTargetSpacing = 1 * 60; // mdl: 1 minutes
