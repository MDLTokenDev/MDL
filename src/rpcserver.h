...
extern UniValue setzmdlseed(const UniValue& params, bool fHelp);
extern UniValue getzmdlseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmdl(const UniValue& params, bool fHelp);
extern UniValue dzmdlstate(const UniValue& params, bool fHelp);
