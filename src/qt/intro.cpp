...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MDL Community Token Core"),
     ...
     * override -datadir in the mdl.conf file in the default data directory
     * (to be consistent with mdld behavior)
     */
    if (dataDir != getDefaultDataDirectory())
