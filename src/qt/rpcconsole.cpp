                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMDLPathCustom = GetArg("-zmdlbackuppath", "");
    ...
    if(!strzMDLPathCustom.empty()) {
        ui->wallet_customzmdlbackuppath->setText(QString::fromStdString(strzMDLPathCustom));
        ui->wallet_customzmdlbackuppath_label->setVisible(true);
        ui->wallet_customzmdlbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMDLPathCustom.empty()) && nCustomBackupThreshold > 0) {
