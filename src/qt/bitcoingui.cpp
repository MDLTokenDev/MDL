                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MDL Community Token Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mdl: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MDL Community Token Core"), this);
    aboutAction->setStatusTip(tr("Show information about MDL Community Token Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MDL Community Token Core help message to get a list with possible mdl command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MDL Community Token Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("MDL Community Token Core"); // default title
