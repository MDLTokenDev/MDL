                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zMDL || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending MDL because you wouldn't check it anyway.
    if (context == Context::Send_MDL || context == Context::Send_zMDL) {
