...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MDL Community Token Core mdl-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mdl-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mdl transaction") + "\n" +
                               "  mdl-tx [options] -create [commands]   " + _("Create hex-encoded mdl transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mdl transaction
