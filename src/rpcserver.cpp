...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mdl features */
        {"mdl", "masternode", &masternode, true, true, false},
        {"mdl", "listmasternodes", &listmasternodes, true, true, false},
        {"mdl", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mdl", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mdl", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mdl", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mdl", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mdl", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mdl", "masternodedebug", &masternodedebug, true, true, false},
        {"mdl", "startmasternode", &startmasternode, true, true, false},
        {"mdl", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mdl", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mdl", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mdl", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mdl", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mdl", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mdl", "mnbudget", &mnbudget, true, true, false},
        {"mdl", "preparebudget", &preparebudget, true, true, false},
        {"mdl", "submitbudget", &submitbudget, true, true, false},
        {"mdl", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mdl", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mdl", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mdl", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mdl", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mdl", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mdl", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mdl", "checkbudgets", &checkbudgets, true, true, false},
        {"mdl", "mnsync", &mnsync, true, true, false},
        {"mdl", "spork", &spork, true, true, false},
        {"mdl", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmdlseed", &getzmdlseed, false, false, true},
        {"zerocoin", "setzmdlseed", &setzmdlseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmdl", &searchdzmdl, false, false, true},
        {"zerocoin", "dzmdlstate", &dzmdlstate, false, false, true}
...
{
    return "> mdl-cli " + methodname + " " + args + "\n";
}
