...
Clone the git repositories for mdl and gitian and then checkout the mdl version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the mdl repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the mdl repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/mdl/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/eastcoastcrypto/mdl
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/mdl.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit mdl=${COMMIT} --url mdl=${URL} ../mdl/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit mdl=${COMMIT} --url mdl=${URL} ../mdl/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit mdl=${COMMIT} --url mdl=${URL} ../mdl/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/mdl-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/mdl-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/mdl-build.assert
```
