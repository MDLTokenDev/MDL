...
In order to support loading of multiple wallets in mdl-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mdl.cpp.
...
Changes to mdl.cpp
----------------------
mdl.cpp is the entry point into mdl-qt, and as such, will require some minor modifications to provide hooks for
