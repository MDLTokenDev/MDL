...
RESOURCES += src/qt/mdl.qrc src/qt/mdl_locale.qrc

TRANSLATIONS += src/qt/locale/mdl_bg.ts \
                src/qt/locale/mdl_de.ts \
                src/qt/locale/mdl_en.ts \
                src/qt/locale/mdl_es.ts \
                src/qt/locale/mdl_fi.ts \
                src/qt/locale/mdl_fr.ts \
                src/qt/locale/mdl_it.ts \
                src/qt/locale/mdl_ja.ts \
                src/qt/locale/mdl_pl.ts \
                src/qt/locale/mdl_pt.ts \
                src/qt/locale/mdl_ru.ts \
                src/qt/locale/mdl_sk.ts \
                src/qt/locale/mdl_sv.ts \
                src/qt/locale/mdl_vi.ts \
                src/qt/locale/mdl_zh_CN.ts \
                src/qt/locale/mdl_zh_TW.ts
